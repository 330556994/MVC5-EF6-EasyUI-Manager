...
{
	public class Virtual_DEF_TestJobsDetailStepsModel
	{
			...
			public virtual Nullable<System.DateTime> TestDt { get; set; }
			public virtual string Developer { get; set; }
			public virtual Nullable<System.DateTime> PlanStartDt { get; set; }
			public virtual Nullable<System.DateTime> PlanEndDt { get; set; }
